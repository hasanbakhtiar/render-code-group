            ...
            <tbody>
              {productData.map((item, index) => (
                <tr key={item.id}>
                  ...
                  <td>{item.price}</td>
                  <td>{item.category}</td>
                  <td><Link to={`/dashboard/product/edit/${item.id}`} className='btn btn-warning'>Edit</Link></td>
                  <td><button onClick={() => {productDeleteAction(item.id) }} className='btn btn-danger'>X</button></td>
                </tr>
              ))}
